# school_data.py
# AUTHOR NAME: Adeel_Ahmed_Salman
#
# This is a terminal-based application designed to compute and display statistics based on provided data.
# Ensure you include the main function listed below. You may add extra classes, functions, variables, etc.
# You can import any modules from the standard Python library.
...
def combine_and_reshape_data(years):
    """
    Combine yearly data arrays into a single array and reshape it into a 3D array.
...
def get_school_index(school_input):
    """
    Retrieve the index of a school based on its name or code.
...
def main():
    ...
    # Display the shape and dimensions of the reshaped data
